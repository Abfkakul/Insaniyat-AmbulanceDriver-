...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(SignInActivity.this,""+mFirebaseUser.getEmail(), Toast.LENGTH_SHORT).show();
            ...
            drefUser.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>()
            {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot)
                {
                    ...
                    {
                        Toast.makeText(SignInActivity.this,"Driver Logged in", Toast.LENGTH_SHORT).show();
            ...
            }).addOnFailureListener(new OnFailureListener()
            {
                ...
                {
                    Toast.makeText(SignInActivity.this,"Error Occurred : "+e, Toast.LENGTH_SHORT).show();
                }
            });
        }
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email,pwd).addOnCompleteListener(SignInActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            if(task.isSuccessful())
                            {
                                ...
                                {
                                    final DocumentReference dref = db.collection("Ambulance Drivers").document(""+email);
                                    dref.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>()
                                    {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot)
                                        {
                                            if(documentSnapshot.exists())
                                            {
                                                Toast.makeText(SignInActivity.this,documentSnapshot.getString("name")+" Login Successful!", Toast.LENGTH_SHORT).show();
                                            ...
                                            {
                                                Toast.makeText(SignInActivity.this,documentSnapshot.getString("name")+"Not a registered User", Toast.LENGTH_SHORT).show();
                                                emailId.setText("");
                                                password.setText("");
                            ...
                            {
                                Toast.makeText(SignInActivity.this,"Incorrect Email or Password, Please Login Again ", Toast.LENGTH_SHORT).show();
                                FirebaseAuth.getInstance().signOut();
